...
class AdbPairingTutorialActivity : AppCompatActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    binding.apply {
      ...
      // StarterActivity
      openStarterButton.setOnClickListener { openStarterWithAdb() }

      openShell.setOnClickListener {
        startActivity(Intent(this@AdbPairingTutorialActivity, ShellActivity::class.java))
      }
    }
  }
    ...
    try {
      ...
      if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S &&
        ...
        if (mode == AppOpsManager.MODE_ERRORED) {
          Toast.makeText(this, "OP_START_FOREGROUND is denied.", Toast.LENGTH_LONG).show()
        }
